	...
	<div class="product">
		...
		<div class="product-content">
			<div class="table-wrap">
				<div>
					<el-table size="small" :data="tableData" style="width: 100%;margin-bottom: 20px;"
						row-key="access_id" border default-expand-all ref="theTable"
						...
						<el-table-column prop="is_show" label="是否显示" width="80">
							<template #default="scope">
								<el-switch v-model="scope.row.is_show" :active-value="1" :inactive-value="0" @change="isShowFunc(scope.row)" active-color="#13ce66" inactive-color="#cccccc"></el-switch>
							</template>
						</el-table-column>
						...
						<el-table-column prop="name" label="操作" width="230">
							<template #default="scope">
								<el-button @click="addClick(scope.row,'copy')" link type="primary" size="small"
									v-if="scope.row.path!='/plus'">一键复制</el-button>
								<el-button @click="addClick(scope.row,'child')" link type="primary"
									size="small">添加子菜单</el-button>
								...
								<el-button @click="deleteClick(scope.row)" link type="primary" size="small"
									v-if="scope.row.path!='/plus'">删除</el-button>
							</template>
						</el-table-column>
					</el-table>
				</div>
		...
		<!--添加-->
		<Add v-if="open_add" :open_add="open_add" :add_type="add_type" :rawData="rawData" :selectModel="selectModel"
			@closeDialog="closeDialogFunc($event, 'add')"></Add>

		<!--编辑-->
		<Edit v-if="open_edit" :open_edit="open_edit" :rawData="rawData" :selectModel="selectModel"
