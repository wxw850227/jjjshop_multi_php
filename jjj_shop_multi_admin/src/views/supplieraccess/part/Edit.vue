<template>
	<el-dialog title="修改菜单&权限" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
		...
		<el-form size="small" :model="formData" :rules="formRules" ref="form">
			...
			<el-form-item label="路径" prop="path" :label-width="formLabelWidth">
				<el-input v-model="formData.path" autocomplete="off" placeholder="请输入组件文件路径"
			...
			<el-form-item label="排序" prop="sort" :label-width="formLabelWidth"><el-input v-model="formData.sort"
					placeholder="请输入排序" type="number"></el-input></el-form-item>
		</el-form>
		<!--操作按钮-->
		<template #footer>
...
<script>
import {suppliereditAccess} from '@/api/access.js';
import {
	deepClone
} from '@/utils/base.js';
export default {
