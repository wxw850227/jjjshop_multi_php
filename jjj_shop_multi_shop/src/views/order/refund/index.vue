      ...
      <div class="table-wrap">
        ...
        <el-table :data="tableData" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="" label="处理状态" width="130">
            <template #default="scope">
              <div v-if="scope.row.status.value == 0">
                ...
                <!-- 商家收货状态-->
                <p v-if="scope.row.type.value != 30 && scope.row.is_agree.value == 10 && scope.row.is_user_send == 1 && scope.row.is_receipt == 0">
                  <span>商家收货：</span>
          ...
          <el-table-column fixed="right" label="操作" width="80">
            <template #default="scope">
              <p><el-button @click="Detail(scope.row.order_refund_id)"  link type="primary" size="small">售后详情</el-button></p>
            </template>
          </el-table-column>
        </el-table>
      </div>
