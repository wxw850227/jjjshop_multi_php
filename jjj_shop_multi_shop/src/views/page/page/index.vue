          ...
          <el-table-column fixed="right" label="操作" width="90">
            <template #default="scope">
              <el-button
                ...
                type="primary"
                size="small"
                v-auth="'/page/page/edit'"
                >编辑</el-button
              >
              <el-button
                v-if="scope.row.page_type == 20"
                @click="deleteClick(scope.row.page_id)"
                link
                type="primary"
                size="small"
                v-auth="'/page/page/delete'"
                >删除
              </el-button>
            </template>
          </el-table-column>
...
<script>
import { PageList, deletePage, setHome } from "@/api/page.js";
export default {
  data() {
    return {
      /*是否加载完成*/
