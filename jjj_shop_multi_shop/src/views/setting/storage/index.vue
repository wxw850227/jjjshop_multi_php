    ...
    <el-form size="small" ref="form" :model="form" label-width="200px">
      ...
      <el-form-item label="默认上传方式">
        <div>
          <el-radio v-model="form.radio" label="local" @change="getRadio"
            >本地 (不推荐)</el-radio
          >
          <el-radio v-model="form.radio" label="qiniu" @change="getRadio"
            >七牛云存储</el-radio
          >
      ...
      <div v-if="form.radio == 'qiniu'">
        <el-form-item label="存储空间名称 Bucket"
          ><el-input
            v-model="form.engine.qiniu.bucket"
            class="max-w460"
          ></el-input
        ></el-form-item>
        <el-form-item label="ACCESS_KEY AK"
          ><el-input
            v-model="form.engine.qiniu.access_key"
            class="max-w460"
          ></el-input
        ></el-form-item>
        <el-form-item label="SECRET_KEY SK"
          ><el-input
            v-model="form.engine.qiniu.secret_key"
            class="max-w460"
          ></el-input
        ></el-form-item>
        <el-form-item label="空间域名 Domain">
          <el-input
            v-model="form.engine.qiniu.domain"
            class="max-w460"
          ></el-input>
          <div class="tips">
      ...
      <div v-if="form.radio == 'aliyun'">
        <el-form-item label="存储空间名称 Bucket"
          ><el-input
            v-model="form.engine.aliyun.bucket"
            class="max-w460"
          ></el-input
        ></el-form-item>
        <el-form-item label="AccessKeyId"
          ><el-input
            v-model="form.engine.aliyun.access_key_id"
            class="max-w460"
          ></el-input
        ></el-form-item>
        <el-form-item label="AccessKeySecret"
          ><el-input
            v-model="form.engine.aliyun.access_key_secret"
            class="max-w460"
          ></el-input
        ></el-form-item>
        <el-form-item label="空间域名 Domain">
          <el-input
            v-model="form.engine.aliyun.domain"
            class="max-w460"
          ></el-input>
          <div class="tips">
            请补全http:// 或 https://，例如：http://static.cloud.com
...
<script>
import { storageDetail, editStorage } from "@/api/setting.js";
