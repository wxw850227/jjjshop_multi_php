          ...
          <el-table-column fixed="right" label="操作" width="90px">
            <template #default="scope">
              ...
              <el-button
                ...
                type="primary"
                size="small"
                v-auth="'/setting/delivery/delete'"
                >删除</el-button
              >
            </template>
          </el-table-column>
...
<script>
import { deliveryList, deleteDelivery } from "@/api/setting.js";
