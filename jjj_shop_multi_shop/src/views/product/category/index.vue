	...
	<div class="product">
		...
		<div class="common-level-rail">
			<el-button size="small" type="primary" @click="addClick" icon="Plus"
				v-auth="'/product/category/add'">添加分类</el-button>
		</div>
				...
				<el-table size="small" :data="tableData" row-key="category_id" default-expand-all
					...
					<el-table-column prop="" label="图片" width="180">
						<template #default="scope">
							<img v-img-url="hasImages(scope.row.images)" alt="" :width="50" />
						</template>
					</el-table-column>
					...
					<el-table-column fixed="right" label="操作" width="100">
						<template #default="scope">
							<el-button @click="editClick(scope.row)" link type="primary" size="small"
								v-auth="'/product/category/edit'">编辑</el-button>
							<el-button @click="deleteClick(scope.row)" link type="primary" size="small"
								v-auth="'/product/category/delete'">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
			</div>
