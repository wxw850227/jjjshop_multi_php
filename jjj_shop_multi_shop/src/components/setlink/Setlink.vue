<template>
	<el-dialog title="超链接设置" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
		...
		<el-tabs type="border-card" v-model="activeName">
			...
			<el-tab-pane label="营销" name="market">
				<Marketing v-if="activeName == 'market'" @changeData="activeDataFunc"></Marketing>
			</el-tab-pane>
			<el-tab-pane label="产品" name="product">
				<Products v-if="activeName == 'product'" @changeData="activeDataFunc"></Products>
			</el-tab-pane>
			<el-tab-pane label="文章" name="Article">
				<Article v-if="activeName == 'Article'" @changeData="activeDataFunc"></Article>
			</el-tab-pane>
			<el-tab-pane label="自定义" name="diypage">
				<DiyPage v-if="activeName == 'diypage'" @changeData="activeDataFunc"></DiyPage>
			</el-tab-pane>
