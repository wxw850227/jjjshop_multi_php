<template>
	<el-dialog title="选择规格" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
		:close-on-press-escape="false" width="600px">
		<div>
			<div class="table-wrap">
				<el-table size="small" :data="specsList" border style="width: 100%" highlight-current-row
...
<script>
import {chooseSpec} from '@/api/product.js';
export default {
	data() {
		return {
			/*是否加载完成*/
