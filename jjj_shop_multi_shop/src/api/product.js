...
export async function catList(data) {
	return request({
		url: '/shop/product.category/index',
		method: 'post',
		data,
	});
}
...
export async function catDel(data) {
	return request({
		url: '/shop/product.category/delete',
		method: 'post',
		data,
	});
}
...
export async function catEdit(data) {
	return request({
		url: '/shop/product.category/edit',
		method: 'post',
		data,
	});
}
...
export async function productList(data) {
	return request({
		url: '/shop/product.product/index',
		method: 'post',
		data,
	});
}
...
export async function delProduct(data) {
	return request({
		url: '/shop/product.product/delete',
		method: 'post',
		data,
	});
}   
 ...
 * @returns
 */
export async function auditProduct(data) {
	return request({
		url: '/shop/product.product/audit',
		method: 'post',
		data,
	});
}
...
export async function addSpecValue(data) {
	return request({
		url: '/shop/product.spec/addSpecValue',
		method: 'post',
		data,
	});
}       
...
export async function getActiveProductList(data) {
	return request({
		url: '/shop/plus.fans.product/lists',
		method: 'post',
		data,
	});
}    
...
export async function getCommentList(data) {
	return request({
		url: '/shop/product.comment/index',
		method: 'post',
		data,
	});
}      
...
export async function getComment(data) {
	return request({
		url: '/shop/product.comment/detail',
		method: 'post',
		data,
	});
}     
...
export async function delComment(data) {
	return request({
		url: '/shop/product.comment/delete',
		method: 'post',
		data,
	});
}     
...
export async function cateImage(data) {
	return request({
		url: '/shop/product.category/image',
		method: 'post',
		data,
	});
} 
...
export async function changeStatus(data) {
	return request({
		url: '/shop/product.product/state',
		method: 'post',
		data,
	});
} 
