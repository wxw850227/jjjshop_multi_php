...
export async function couponList(data) {
	return request({
		url: '/shop/plus.coupon.coupon/index',
		method: 'post',
		data,
	});
}
...
export async function addCoupon(data) {
	return request({
		url: '/shop/plus.coupon.coupon/add',
		method: 'post',
		data,
	});
}
...
export async function couponDetail(data) {
	return request({
		url: '/shop/plus.coupon.coupon/couponDetail',
		method: 'post',
		data,
	});
}
...
export async function editCoupon(data) {
	return request({
		url: '/shop/plus.coupon.coupon/edit',
		method: 'post',
		data,
	});
}
...
export async function deleteCoupon(data) {
	return request({
		url: '/shop/plus.coupon.coupon/delete',
		method: 'post',
		data,
	});
}
...
export async function receiveList(data) {
	return request({
		url: '/shop/plus.coupon.coupon/receive',
		method: 'post',
		data,
	});
}
...
export async function toSendCoupon(data) {
	return request({
		url: '/shop/plus.coupon.coupon/SendCoupon',
		method: 'get',
		data,
	});
}
