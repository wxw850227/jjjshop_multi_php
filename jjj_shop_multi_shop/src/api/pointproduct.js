...
export async function productList(data) {
	return request({
		url: '/shop/plus.points.product/index',
		method: 'post',
		data,
	});
}
...
export async function addProduct(data) {
	return request({
		url: '/shop/plus.points.product/add',
		method: 'post',
		data,
	});
}
...
export async function getPointProduct(data) {
	return request({
		url: '/shop/plus.points.product/edit',
		method: 'get',
		data,
	});
}
...
export async function deleteProduct(data) {
	return request({
		url: '/shop/plus.points.product/delete',
		method: 'post',
		data,
	});
}
...
export async function saveConfig(data) {
	return request({
		url: '/shop/plus.points.product/settings',
		method: 'post',
		data,
	});
}  
...
export async function getExchange(data) {
	return request({
		url: '/shop/plus.points.product/record',
		method: 'post',
		data,
	});
}
/**
 ...
 export async function stateSet(data) {
 	return request({
 		url: '/shop/plus.points.Product/state',
 		method: 'post',
 		data,
 	});
 }        
