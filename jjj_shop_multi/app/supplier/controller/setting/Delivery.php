...
use app\supplier\model\settings\Delivery as DeliveryModel;
...
class Delivery extends Controller
{
    ...
    public function add()
    {
        ...
        $model = new DeliveryModel;
        $data = $this->postData();
        if ($model->add($data, $this->getSupplierId())) {
    ...
    public function detail($delivery_id = 0)
    {
        ...
        // 详情
        $detail = DeliveryModel::detail($delivery_id, $this->getSupplierId());
        // 获取配送区域及运费设置项
    ...
    public function edit($delivery_id = 0)
    {
        ...
        $model = DeliveryModel::detail($delivery_id, $this->getSupplierId());
        // 更新记录
