...
export async function getRoleList(data) {
	return request({
		url: '/supplier/auth.user/getRoleList',
		method: 'post',
		data,
	});
}
...
export async function getUserInfo(data) {
	return request({
		url: '/supplier/auth.user/getUserInfo',
		method: 'post',
		data,
	});
}
