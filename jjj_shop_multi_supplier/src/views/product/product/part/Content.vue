  ...
  <div>
    ...
    <el-form-item label="详情图片：" v-if="form.model.is_picture == 1">
      <div class="draggable-list">
        <template v-if="form.model.contentImage && form.model.contentImage.length > 0">
          <draggable
            v-model="form.model.contentImage"
            group="specContent"
            item-key="id"
  ...
  methods: {
    ...
    returnImgsFunc(e) {
      if (e != null) {
        ...
        this.form.model.contentImage = JSON.parse(JSON.stringify(imgs));
      }
