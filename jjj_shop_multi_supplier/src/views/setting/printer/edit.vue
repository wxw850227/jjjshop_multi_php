  ...
  <div class="product-add">
    ...
    <el-form size="small" ref="form" :model="form" label-width="200px">
      ...
      <div v-if="form.printer_type == 'PRINT_CENTER'">
        <el-form-item
          label="打印机编号 "
          prop="PRINT_CENTER.deviceNo"
          :rules="[{ required: true, message: ' ' }]"
        >
          <el-input
            v-model="form.PRINT_CENTER.deviceNo"
            class="max-w460"
          ></el-input>
        </el-form-item>
...
<script>
import { printerDetail, editPrinter } from "@/api/setting.js";
