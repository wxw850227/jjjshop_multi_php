      ...
      <div class="table-wrap">
        ...
        >
          ...
          <el-table-column
            ...
            width="70"
          ></el-table-column>
          <el-table-column prop="status_text" label="直播状态">
          </el-table-column>
          ...
          <el-table-column prop="anchor_name" label="主播名">
            <template #default="scope">
              <div class="user-info d-s-c">
                <span class="ml10">{{ scope.row.users.nickName }}</span>
              </div>
            </template>
          </el-table-column>
          ...
          <el-table-column fixed="right" label="操作" width="120">
            <template #default="scope">
              ...
              <el-button
                ...
                type="primary"
                size="small"
                v-auth="'/plus/live/room/user_gift'"
                >礼物排行</el-button
              >
            </template>
          </el-table-column>
  ...
  methods: {
    ...
    getTableList() {
      ...
      getRoom(Params, true)
        .then((data) => {
          self.loading = false;
          self.tableData = data.data.list.data.map((item) => {
            if (!item.users) {
