...
export const useUserStore = defineStore('main', {
	...
	actions: {
		...
		async afterLogin(info) {
			...
			this.userInfo.username = data.user_name || data;
			this.userInfo.shopName = data.shop_name || '总店';
			this.userInfo.version = data.version;
			this.userInfo.url = data.url;
			this.userInfo.supplier_user_id = data.supplier_user_id;
			this.userInfo.shop_supplier_id = data.shop_supplier_id;
